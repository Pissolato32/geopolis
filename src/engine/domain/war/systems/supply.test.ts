...
describe('SupplySystem', () => {
  it('should refuel units that are within supply range of a friendly supply source', () => {
    ...
    worldState.createEntity(countryId, [{
      type: PROVINCE_TYPE,
      provinces: [
        makeProvince('prov-a1', countryId, ['prov-a2'], { terrain: 'plains', isSupplySource: true }),
        makeProvince('prov-a2', countryId, ['prov-a1'], { terrain: 'plains' }),
      ],
  ...
  it('should cut supply when no friendly supply source is reachable', () => {
    ...
    worldState.createEntity(countryId, [{
      type: PROVINCE_TYPE,
      provinces: [
        makeProvince('prov-a1', countryId, ['prov-b1'], { terrain: 'plains', isSupplySource: true }),
      ],
    } as unknown as IComponent]);
