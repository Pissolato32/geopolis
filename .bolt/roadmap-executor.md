# 🚀 GeoPolis Roadmap Executor Specification

Use this specification when tasked with extending the GeoPolis geopolitical simulation engine, refactoring architecture, or implementing features from `docs/future-roadmap.md`.
...
2. Run `npm test` -> MUST pass 100% of unit/integration tests (`406+ passed tests`).
