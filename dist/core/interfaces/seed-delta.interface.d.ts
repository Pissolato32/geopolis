...
export interface ISanitizationReport {
    ...
    readonly aliasesResolved: ReadonlyArray<{
        rawId: string;
        canonicalId: EntityId;
    }>;
    readonly valuesClamped: ReadonlyArray<{
        entityId: string;
        field: string;
        original: number;
        clamped: number;
    }>;
    readonly fieldsDropped: ReadonlyArray<{
        entityId: string;
        field: string;
        reason: string;
    }>;
...
//# sourceMappingURL=seed-delta.interface.d.ts.map