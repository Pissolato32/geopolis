        ...
        try {
            ...
            if (typeof parsed === 'object' &&
                ...
                return {
                    ...
                    actorEntityId: parsed.actorEntityId,
                    ...(typeof parsed.targetEntityId === 'string' ? { targetEntityId: parsed.targetEntityId } : {}),
        ...
        switch (payload.actionType) {
            case 'economy.impose-sanction':
                if (!params['targetCountryId'])
                    errors.push('impose-sanction requires targetCountryId parameter');
                break;
            ...
            case 'war.move-ordered':
                if (!params['unitId'])
                    errors.push('move-ordered requires unitId parameter');
                if (!params['targetProvinceId'])
                    errors.push('move-ordered requires targetProvinceId parameter');
                break;
            case 'war.deploy-unit':
                if (!params['countryId'])
                    errors.push('deploy-unit requires countryId parameter');
                if (!params['provinceId'])
                    errors.push('deploy-unit requires provinceId parameter');
...
//# sourceMappingURL=strict-intent-parser.js.map