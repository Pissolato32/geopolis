export declare const WAR_FUEL_CONSUMED_EVENT = "war.fuel-consumed";
export declare const WAR_FUEL_DEPLETED_EVENT = "war.fuel-depleted";
export declare const WAR_COMBAT_RESOLVED_EVENT = "war.combat-resolved";
export declare const WAR_UNIT_MOVED_EVENT = "war.unit-moved";
export declare const WAR_MOVE_ORDERED_EVENT = "war.move-ordered";
export declare const WAR_PROVINCE_CAPTURED_EVENT = "war.province-captured";
export declare const WAR_PEACE_REQUESTED_EVENT = "war.peace-requested";
...
export declare const WAR_PEACE_SIGNED_EVENT = "war.peace-signed";
...
//# sourceMappingURL=war.events.d.ts.map