export declare const DIPLOMACY_TENSION_CHANGED_EVENT = "diplomacy.tension-changed";
export declare const DIPLOMACY_TREATY_SIGNED_EVENT = "diplomacy.treaty-signed";
...
//# sourceMappingURL=diplomacy.events.d.ts.map