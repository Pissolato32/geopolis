...
export declare const ECONOMY_SANCTION_TYPE: ComponentType;
export type SanctionType = 'trade-embargo' | 'asset-freeze' | 'technology-ban' | 'oil-embargo';
...
//# sourceMappingURL=sanction.components.d.ts.map