export declare const ECONOMY_GDP_UPDATED_EVENT = "economy.gdp-updated";
export declare const ECONOMY_RESOURCE_SHORTAGE_EVENT = "economy.resource-shortage";
...
//# sourceMappingURL=economy.events.d.ts.map